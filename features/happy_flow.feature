...
And See the information of the value that they lend me and the initial fee that I must have 'prestamo' '<validation_values_lend>'
Examples:
...
And See the information of the value that they lend me and the initial fee that I must have 'value quote' '<validation_values_credit>'
Examples:
